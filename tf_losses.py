...
# Extracted from:
#  https://github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/losses/python/metric_learning/metric_loss_ops.py
#  https://www.tensorflow.org/versions/r1.5/api_docs/python/tf/contrib/losses/metric_learning/triplet_semihard_loss
