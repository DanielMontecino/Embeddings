...
from keras.layers import Dropout, Lambda, Flatten, Dense, Input, MaxPooling2D, LocallyConnected2D, AveragePooling2D, Conv2D
from keras.models import Model
import keras.backend as K
from models.Base import BaseNet
from models.resnet_model import resnet_v1, resnet_v2
...
class Resnet50(BaseNet):
    ...
    def def_model(self):
        ...
        #model_ = Conv2D(128, 1, padding='same', activation='elu')(model_)
        #model_ = MaxPooling2D(pool_size=(2, 2))(model_)
        model_ = AveragePooling2D(pool_size=(2, 2))(model_)
        #model_ = LocallyConnected2D(128, 1, padding='valid', activation='relu')(model_)
...
class Resnet20(BaseNet):
    ...
    def def_model(self):
        return resnet_v2(input_shape=self.input_size, depth=20)
